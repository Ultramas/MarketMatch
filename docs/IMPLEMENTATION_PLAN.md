...
- Extra adapters/stubs (`src/adapters/ebay.js`, `src/adapters/craigslist.js`, `src/lib/coupons.js`) remain inactive scaffolds and are not part of the active Facebook -> eBay runtime path.
